...
public class Linked {
    ...
    public boolean delete(Object obj) {
        ...
        // obj 在的节点
        Node t = first; // 假设first就是obj在的位置

        Node prev = null; // 删除对象的前一个对象
        ...
        // 如果 t 是第一个元素
        if (prev == null) {
            Node next = first.getNext(); //保存两个对象之间的连接
            first.setNext(null);
            first = next;
            size--;
            return true;
    ...
    public int indexOf(Object obj) {
        ...
        Node node = first; // 假设node就是我们要查找的obj在的节点
        int index = 0; // 对应的下标
